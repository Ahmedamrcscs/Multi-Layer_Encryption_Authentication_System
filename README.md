...
GUI & CLI Support: Includes a user-friendly Tkinter interface and an underlying command-line menu structure.

Persistent Storage: Saves registered users and their encrypted tokens to a local users.txt file.
